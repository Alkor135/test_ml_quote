# -*- coding: utf-8 -*-
"""
Файлы csv по дням, объединяет в один csv файл
Меняет заголовки полей (убирает лишние символы (<, >)), приводит названия к нижнему регистру
Меняет индекс на дату и время.
"""
import pandas as pd
